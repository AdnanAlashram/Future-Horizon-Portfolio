export type Project = {
  ...
  /**
   * Screenshots for the case study. The first is used as the full-bleed cover,
...
export const projects: Project[] = [
  {
    ...
    images: [
      {
        src: "/images/projects/ptpapp.png",
        alt: "PTP passenger application showing live bus tracking on a map",
      },
      {
        src: "/images/projects/ptp-dashboard.png",
        alt: "PTP admin dashboard with fleet, route and driver status panels",
        caption: "Admin dashboard",
      },
    ],
    overview:
      "PTP is a multi-role transportation ecosystem that connects passengers, drivers, administrators and merchants through web and mobile applications.",
    challenge:
      "Public transportation operations span passenger trips, vehicle movement, routes, stops, subscriptions and administrative decisions. PTP brings these connected responsibilities into one product system.",
    solution:
      "The platform combines real-time vehicle location updates, route visualization, stop management, administrative workflows and a QR-based digital transportation card with zone and day/week/month subscription types.",
    features: [
    ...
    outcome:
      "A complete transportation ecosystem with distinct tools for the people and operations that keep the service moving.",
    ...
    images: [
      {
        ...
        alt: "Sahtak healthcare platform landing experience",
      },
    ],
    overview:
  ...
  },
  {
    ...
    technologies: ["React", "TypeScript", "Google Maps"],
    coverImage: "/images/projects/syrian-scientific-school-logo.png",
    coverFit: "contain",
    // No screenshots available for this project yet — the case study renders
